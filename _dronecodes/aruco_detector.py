...
class ArucoDetector:
    ...
    def __init__(self, aruco_size, marker_size=6, total_markers=50):
    ...
    def find_aruco_markers(self, frame):
        ...
        bbox, ids, rejected = cv2.aruco.detectMarkers(imgGray, self.aruco_dict, parameters=self.aruco_params
                                                   )
        ...
        if ids is not None:
            ...
            rvecs, tvecs, obj_points = aruco.estimatePoseSingleMarkers(bbox, self.aruco_size,
...
if __name__ == "__main__":
    ...
    aruco_detector = ArucoDetector(aruco_size=0.05,
                                   marker_size=6, total_markers=100)
