...
parser = argparse.ArgumentParser(
    deion="""Callibration camera . Starts a video stream from camera to collect
    data for callibration until n frames are collected or d button is pressed""")
parser.add_argument("--number_of_squares_x", type=int, default=5,
...
parser.add_argument("--square_size", type=float, default=0.035,
